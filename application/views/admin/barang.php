...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
         ...
         <center>
             <h1 class="h3 mb-2 text-primary-800"><strong>Gudang Barang</strong></h1>
             <!-- <h3 class="h3 nb-2 text-primary-600">biar petugas yang akan menunjukkan barang</h3> -->
</center>
        ...
        foreach ($barang as $b) : ?> 
            <tr>
                ...
                <td class="text-center">
                   ...
                   class=" btn btn-sm btn-danger" href="<?= base_url('admin/databaranglelang/hapus/' . 
   ...
   <div class="modal fade" id="tambah_barang" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <!-- <input type="text" name="id_user" id="id_user" class="form-control" value="<?= $users['id_user']?>"readonly> -->
