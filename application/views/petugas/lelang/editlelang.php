                ...
                <div class="form-group">
                    ...
                    <select name="product" id="product" class="form-control">
                        ...
                        <?php foreach ($products as $product) : ?>
                            <option value="<?= $product->id_barang ?>" <?= ($auction->id_barang == $product->id_barang) ? 'selected=""' : null ?>><?= $product->nama_barang ?>
                        </option>
                        <?php endforeach; ?>
                    </select>
                    <?= form_error('product') ?>
                ...
                <div class="form-group">
                    ...
                    <select name="user" id="user" class="form-control">
                        ...
                        <?php foreach ($users as $user) : ?>
                            <option value="<?php echo $user->id_user ?>" <?php echo ($auction->id_user == $user->id_user) ? 'selected=""' : null ?>><?php 
                                echo $user->nama_lengkap ?></option>
                        <?php endforeach; ?>
                    </select>
                    <?= form_error('user') ?>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="petugas" id="petugas" class="form-control">
                        ...
                        <?php foreach ($staffs as $staff) : ?>
                            <option value="<?php echo $staff->id_petugas ?>" <?php echo ($auction->id_petugas == $staff->id_petugas) ? 
                            'selected=""' : null ?>><?= $staff->nama_petugas ?></option>
                        <?php endforeach; ?>
                    </select>
                    <?= form_error('petugas') ?>
                </div>
